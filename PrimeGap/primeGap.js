...
Inputs: g (Gap integer), m(start of the search), n(end of the search)
Output: The first pair of two prime numbers spaced with the gap

1 - Detect if the number is prime
...
console.log(primeGap(2, 5, 7)); // [5, 7]
console.log(primeGap(2, 3, 50)); // [3, 5]
...
// console.log(primeGap(4, 130, 200)); // [163, 167]
